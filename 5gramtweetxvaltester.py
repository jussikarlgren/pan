...
#        knownvectors = newknownvectors
    ...
    for item in testvectors:
        ...
        for iii in range(itempooldepth):
            try:
                logger(itemspace.name[item] + " (" + itemspace.category[item] + ") " +
                       "\t" + str(neighbours[item][sortedneighbours[iii]]) + "\t" + itemspace.name[
                           sortedneighbours[iii]] +
                       " (" + itemspace.category[sortedneighbours[iii]] + ") "
                       , debug)
            except:
